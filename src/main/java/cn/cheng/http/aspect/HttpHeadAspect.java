...
public class HttpHeadAspect {
    public static final Logger logger = LoggerFactory.getLogger(HttpHeadAspect.class);
    @Resource
    private WebClient webClient;

    @Pointcut("@annotation(cn.cheng.http.annotation.Head)")
    ...
    public Object beforePointcut(ProceedingJoinPoint joinPoint) {
        ...
        String url = head.url();
        logger.info("请求:{},方法：Head", url);
        String[] heads = head.heads();
        String[] attrs = head.attrs();
        String[] cookies = head.cookies();
